...
tf.app.flags.DEFINE_integer('max_dec_steps', 1, 'max timesteps of decoder (max summary tokens)')
...
def run_training(model, batcher, sess_context_manager, sv, summary_writer):
  ...
  with sess_context_manager as sess:
    ...
    while True: # repeats until interrupted
      ...
      t0=time.time()
      # print('!!!!!!!!!!!!!')
      # print('batch.enc_batch_extend_vocab is ',batch.enc_batch_extend_vocab)
...
def main(unused_argv):
  ...
  # print('hps.mode is',hps.mode.value)
